...
-- 10. 驗證修復結果
SELECT 
  'Stores 表結構檢查' as check_type,
  column_name as result
FROM information_schema.columns 
WHERE table_name = 'stores' 
  AND table_schema = 'public'
  AND column_name IN ('category', 'is_trusted', 'is_partner_store', 'rating', 'approval')
ORDER BY column_name;

-- 11. 測試分類統計視圖
SELECT * FROM public.category_stats LIMIT 5;
