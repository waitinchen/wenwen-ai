...
async function testAttractionFix() {
  console.log('🎯 測試景點推薦功能修復');
  console.log('=========================');
  
  const tests = [
    {
      query: '請推薦景點',
      description: '景點推薦 - 應回景點資料而非停車場',
      shouldContain: ['景點推薦', '鳳儀書院', '鳳山龍山寺', '歷史古蹟', '國定古蹟'],
      shouldNotContain: ['保亭鳳山行政停車場', '寶盛鳳山中山東路停車場', '肯塔基美語']
    },
    {
      query: '推薦觀光景點',
      description: '觀光景點查詢 - 應回景點資料',
      shouldContain: ['景點推薦', '鳳儀書院', '鳳山龍山寺'],
      shouldNotContain: ['停車場', '美語']
    },
    {
      query: '有什麼好玩的地方？',
      description: '好玩地方查詢 - 應回景點資料',
      shouldContain: ['景點推薦', '歷史古蹟'],
      shouldNotContain: ['停車場', '美語']
    },
    {
      query: '推薦美食',
      description: '美食推薦 - 應回美食店家（正常功能不受影響）',
      shouldContain: ['美食', '推薦', '店家'],
      shouldNotContain: ['景點推薦', '歷史古蹟']
    }
  ];
...
// 執行測試
testAttractionFix().catch(console.error);
